...
data2 = importdata("~/Documents/PartIILogs/1remandlocal_throughput_latency.log", ' ');
%filter NaN rows
rates = unique(data(:,3));
...
l = legend([p1 p2],[ "Remote Participant only" "Remote Participant and local Participant"]);
